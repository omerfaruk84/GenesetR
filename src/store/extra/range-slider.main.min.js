...
*/
    ...
    (() => {
      ...
      var range_slider = __webpack_require__(682); // CONCATENATED MODULE: ./src/range-slider.css
      var options = {};
      ...
      var update = injectStylesIntoStyleTag_default()(
        range_slider /* default */.Z,
        options
      );

      /* harmony default export */ const src_range_slider =
        range_slider /* default */.Z &&
        range_slider /* default.locals */.Z.locals
          ? range_slider /* default.locals */.Z.locals
          : undefined; // CONCATENATED MODULE: ./src/range-slider.js
...
*/
      ...
      var RangeSlider = /*#__PURE__*/ (function () {
        ...
        function RangeSlider(selector) {
          ...
          this.allProps = _objectSpread(
            _objectSpread(_objectSpread({}, this.defaultProps), props),
            {},
            {
              values: _toConsumableArray(
                props.values || this.defaultProps.values
              ),
              colors: _objectSpread(
                _objectSpread({}, this.defaultProps.colors),
                props.colors
              ),
            }
          );
          ...
          this.documentMouseMoveHandler =
            this.documentMouseMoveHandler.bind(this);
          ...
          [
            ...
            },
            {
              ...
              value: function generatePointPositions() {
                ...
                return this.allProps.values.map(function (value) {
                  ...
                  return Math.floor(
                    (percentage / 100) * _this2.container.offsetWidth
                  );
                });
              },
              /**
            ...
            },
            {
              ...
              value: function initTrack(index) {
                ...
                var trackPointPositions = this.pointPositions.slice(
                  index,
                  index + 2
                );
                track.style.left =
                  Math.min.apply(
                    Math,
                    _toConsumableArray(trackPointPositions)
                  ) + "px";
            ...
            },
            {
              ...
              value: function initPoint(index) {
                ...
                point.style.left = "".concat(
                  (this.pointPositions[index] / this.container.offsetWidth) *
                    100,
                  "%"
                );
            ...
            },
            {
              ...
              value: function draw() {
                ...
                this.points.forEach(function (point, i) {
                  point.style.left = "".concat(
                    (_this6.pointPositions[i] / _this6.container.offsetWidth) *
                      100,
                    "%"
                  );
                });
                this.tracks.forEach(function (track, i) {
                  var trackPointPositions = _this6.pointPositions.slice(
                    i,
                    i + 2
                  );
                ...
                this.tooltip.textContent =
                  this.allProps.values[this.selectedPointIndex];
              },
              /**
            ...
            },
            {
              ...
              value: function railClickHandler(e) {
                ...
                var closestPositionIndex =
                  this.getClosestPointIndex(newPosition);
            ...
            },
            {
              ...
              value: function documentMouseMoveHandler(e) {
                ...
                this.allProps.values[this.selectedPointIndex] =
                  this.possibleValues[Math.floor(newPoisition / this.jump)];
                this.draw();
              },
              /**
            ...
            },
            {
              ...
              value: function pointMouseoverHandler(e, index) {
                var transparentColor = RangeSlider.addTransparencyToColor(
                  this.points[index].style.backgroundColor,
                  16
                );

                if (this.selectedPointIndex < 0) {
                  this.points[index].style.boxShadow = "0px 0px 0px "
                    .concat(Math.floor(this.allProps.pointRadius / 1.5), "px ")
            ...
            },
            {
              ...
              value: function onChange(func) {
                if (typeof func !== "function") {
                  throw new Error(
                    "Please provide function as onChange callback"
                  );
                }
