...
var RangeSlider = /*#__PURE__*/function () {
  ...
  _createClass(RangeSlider, [{
    ...
    value: function initTooltip() {
      ...
      tooltip.style.fontSize = Math.max(this.allProps.pointRadius,11) + "px";
      return tooltip;
    }
    /**
    ...
    value: function draw() {
      ...
      this.points.forEach(function (point, i) {
        var location = _this6.pointPositions[i] / _this6.container.offsetWidth * 100;        
        point.style.left = "".concat(location, "%");
    ...
    value: function documentMouseMoveHandler(e) {
      ...
      if(this.selectedPointIndex ==1 && this.pointPositions[0]>newPoisition) 
      newPoisition =this.pointPositions[0]+1;

      if(this.selectedPointIndex ==1 && this.pointPositions[2]<newPoisition) 
      newPoisition =this.pointPositions[2]-1;

      if(this.selectedPointIndex ==2 && this.pointPositions[1]>newPoisition) 
      newPoisition =this.pointPositions[1]+1;

      if(this.selectedPointIndex ==0 && this.pointPositions[1]<newPoisition) 
       newPoisition =this.pointPositions[1]-1;
